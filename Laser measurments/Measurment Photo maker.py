...
ax1.yaxis.set_ticks(np.arange(-0.1, 2.3, 0.5))
ax2.yaxis.set_ticks(np.arange(-0.1, 2.3, 0.5))
ax3.yaxis.set_ticks(np.arange(-0.1, 2.3, 0.5))
ax4.yaxis.set_ticks(np.arange(-0.1, 2.3, 0.5))
...
fig.text(0.08, 0.5, 'Relative intensity', va='center', rotation='vertical')
plt.xlabel("Wavelength (nm) $\pm 10$nm")
# plt.ylabel("Voltage of CCD (V)")
plt.savefig(".\Results laser spectrum\\feedback lasers averaged.png")
